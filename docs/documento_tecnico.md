...
principio: toda variable se corta en t-1, porque usar el mes en curso es fuga y ese dato
no existe en producción. Construí 156 variables y elegí 100.

**El hallazgo que cambió mi enfoque.** Con partición aleatoria obtenía F1 de 0,747 y Kaggle me
devolvía 0,704: una misma obligación aparece en varios meses, así que esa partición filtra
información entre conjuntos. Pasé a validación temporal, entrenando hasta noviembre y midiendo en
diciembre, y desde ahí el resultado local anticipó el público.
...
**Seguridad.** Exijo un código de un solo uso antes de revelar cualquier dato, y las herramientas
...
código sin llamar a la herramienta, lo que evitaba el bloqueo por fuerza bruta: como nacía de una
alucinación, ninguna prueba unitaria lo habría visto.
...
hay que reservarla antes de operar con volumen.
...
trazable y auditable. Lo que más la mejoraría es registrar la oferta realizada, hoy el techo de la
métrica.
...
partir de mi bitácora del proyecto.
